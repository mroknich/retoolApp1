  ...
  >
    ...
    >
      <Series
        ...
        yData={{
          array: [
            521.25, 524.8, 530.45, 531.2, 536.05, 533, 542.05, 544.2, 540.45,
            552.8, 555.25, 554.8, 553.45, 562.2, 559.05, 565, 569.05, 571.2,
            568.45, 573.8, 572.25, 598.8, 598.45, 589.2, 589.05, 603, 599.05,
            627.2, 615.45, 605.8,
          ],
        }}
        yDataMode="manual"
      ...
      <Series
        ...
        yData={{
          array: [
            97.75, 105.2, 101.55, 99.8, 90.95, 90, 90.95, 101.8, 90.55, 104.2,
            89.75, 84.2, 90.55, 82.8, 77.95, 86, 99.95, 70.8, 68.55, 89.2,
            91.75, 82.2, 96.55, 60.8, 67.95, 86, 47.95, 54.8, 76.55, 55.2,
          ],
        }}
        yDataMode="manual"
        zData={null}
      ...
      <Series
        ...
        yData={{
          array: [
            22.25, 27.8, 26.45, 32.2, 37.05, 37, 42.05, 43.2, 47.45, 48.8,
            48.25, 55.8, 60.45, 61.2, 61.05, 64, 76.05, 81.2, 75.45, 69.8,
            90.25, 97.8, 83.45, 98.2, 102.05, 118, 125.05, 121.2, 124.45, 109.8,
          ],
        }}
        yDataMode="manual"
        zData={null}
